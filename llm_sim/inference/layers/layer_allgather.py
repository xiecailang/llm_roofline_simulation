...
AllGather (Ring All-Gather) 通信模式：
- 总传输量 = (N-1) / N * data_size
- 每个 rank 从其他 (N-1) 个 rank 收集数据

参考 SKILL.md 中的 All-Gather 时延公式
"""

from .layer_base import LayerBase


class LayerAllGather(LayerBase):
    """AllGather通信算子"""
    ...
    def get_comm_bytes(self):
        """Ring All-Gather 总通信量: (N-1) / N * data_size"""
